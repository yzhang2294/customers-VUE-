    ...
    <form role="form" @submit.prevent="updateUser()">
        <div class="well">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="phone" placeholder="请输入电话" v-model="customer.phone">
            </div>
            <div class="form-group">
  ...
  methods: {
      ...
      updateUser:function(){
          if(!this.customer.name || !this.customer.phone|| !this.customer.email){
              ...
              this.$http.put("http://localhost:3000/users/" + this.customer.id,newCustomer)
                .then((data)=>{
                    this.$router.push({path:"/",query:{alert:'[' + newCustomer.name+ ']'+"信息更新成功"}});
                })             
          }
        }
    },
...
<!-- update "scoped" attribute to limit CSS to this component only -->
<style scoped>
